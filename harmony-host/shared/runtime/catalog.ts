...
export class GameCatalog {
  ...
  readonly all: GameDef[] = [
    ...
    },
    {
      ...
      factory: () => new WerewolfPlugin(this.werewolfStore)
    },
    {
      ...
      factory: () => new DoudizhuPlugin()
    }
  ];

  find(id: string): GameDef | undefined { return this.all.find((g) => g.id === id); }
